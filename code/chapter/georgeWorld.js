...
var World = function() {
	...
	this.init = function() { /* Requires implementation */ };
	// A step in the function with time = t
	this.step = function(t) { /* Requires implementation */ };
...
Prospectors.init = function() {

};

Prospectors.step = function() {

};

Prospectors.backgroundLayer = function() {
